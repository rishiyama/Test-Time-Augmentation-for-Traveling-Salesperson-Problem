...
class TSP_net(nn.Module): 
    ...
    def __init__(self, dim_input_nodes, dim_emb, dim_ff, nb_layers_encoder, nb_layers_decoder, nb_heads, max_len_PE,
        ...
        self.start_placeholder_coord = nn.Parameter(torch.rand(2)) # x,y \in [0,1]
    ...
    def forward(self, x, deterministic=False):
        ...
        # h.shape = (bsz, nb_nodes+1, nb_nodes+1, channels)
        # h_encoder.shape = (bsz, nb_nodes+1, dim_emb)

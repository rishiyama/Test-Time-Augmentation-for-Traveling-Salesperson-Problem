...
import random
from models_test.tsp_transformer_tta import TSP_net
...
def get_args():
    ...
    parser.add_argument('--beam_width', required=True,  type=int, help='beamsize width')
...
if __name__ == "__main__":
    ...
    if input_args.data_type == 'x':
        TEST_DATA = '10k_TSP100'
    elif input_args.data_type == 'x_double_tree':
        TEST_DATA = '10k_TSP100_double_tree'
    else:
